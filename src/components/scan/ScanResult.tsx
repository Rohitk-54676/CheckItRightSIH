        ...
        {items.map(
          ([label, value], index) => (
            <motion.div
              ...
              className="group relative overflow-hidden rounded-2xl border border-slate-200 bg-slate-50 p-4 transition-colors hover:border-[#22C55E]/20 hover:bg-[#16A34A]/[0.035]"
            >
              <motion.div
                animate={{
                  x: ["-120%", "180%"],
  ...
  return (
    ...
    >
      <div className="pointer-events-none fixed inset-0 -z-10 overflow-hidden">
        <div className="absolute left-1/4 top-1/4 h-[420px] w-[420px] rounded-full bg-emerald-100/50 blur-[100px]" />
        <div className="absolute right-0 top-1/2 h-[380px] w-[380px] rounded-full bg-sky-100/50 blur-[100px]" />
      </div>

      <motion.div
        variants={sectionVariants}
        className="relative overflow-hidden rounded-[2rem] border border-emerald-200 bg-white shadow-[0_20px_60px_rgba(15,23,42,0.08)]"
      >
        <motion.div
          animate={{
            x: ["-120%", "120%"],
          ...
          <div className="flex flex-col gap-7 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div className="relative mx-auto flex h-48 w-48 shrink-0 items-center justify-center">
              ...
              <motion.div
                ...
                className={`relative flex h-32 w-32 flex-col items-center justify-center rounded-full border-2 ${scoreClasses.border} ${scoreClasses.bg}`}
              >
                {scoreLevel === "GREEN" ? (
                ...
                <span className="mt-1 text-3xl font-black text-slate-900">
                  {score}
                </span>

                <span className={`text-[9px] font-bold uppercase tracking-widest ${scoreClasses.text}`}>
                  {scoreLevel} SCORE
                </span>
              </motion.div>
            </div>
        ...
        <div className="group relative overflow-hidden rounded-2xl border border-slate-200 bg-white p-5">
          ...
          <div className="mt-4 h-1.5 overflow-hidden rounded-full bg-white/[0.06]">
            <motion.div
              ...
              className={`relative h-full rounded-full ${scoreClasses.fill}`}
            >
              <motion.div
                animate={{
                  x: ["-100%", "300%"],
      ...
      <motion.div
        variants={sectionVariants}
        className="relative overflow-hidden rounded-[1.75rem] border border-slate-200 bg-white p-6 sm:p-8"
      >
        <motion.div
          animate={{
            x: ["-100%", "100%"],
      ...
      >
        <div className="flex items-center gap-3">
          <div className="flex h-11 w-11 items-center justify-center rounded-xl border border-slate-200 bg-slate-50 text-slate-600">
      ...
      <motion.div
        variants={sectionVariants}
        className="relative overflow-hidden rounded-[1.75rem] border border-emerald-200 bg-white p-6 sm:p-8"
      >
        <motion.div
          animate={{
            y: ["-100%", "300%"],
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <div className="mt-3 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                        ...
                        {typeof rule.weight === "number" && (
                          <span className="w-fit shrink-0 rounded-full border border-slate-200 bg-white px-2.5 py-1 text-[10px] font-bold text-slate-500">
                            Weight {rule.weight}
                          </span>
                        )}
                      </div>
        ...
        scan.preprocessingImages.length > 0 && (
          ...
          >
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
              ...
              <div className="w-fit rounded-full border border-slate-200 bg-slate-50 px-4 py-2 text-xs font-bold text-slate-500">
      ...
      >
        ...
        <details className="mt-6 overflow-hidden rounded-2xl border border-slate-200">
          <summary className="cursor-pointer bg-slate-50 px-5 py-4 text-sm font-bold text-slate-700 transition hover:bg-slate-50">
            View complete OCR text
          </summary>

          <pre className="max-h-[600px] overflow-auto whitespace-pre-wrap  p-5 text-xs leading-6 text-slate-500">
            {scan?.rawOcrText ||
      ...
      <motion.div
        variants={sectionVariants}
        className="relative overflow-hidden rounded-2xl border border-amber-200 bg-amber-50 p-5"
      >
        <motion.div
          animate={{
            x: ["-120%", "150%"],
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex flex-col gap-3 sm:flex-row">
            <button
              ...
              className="inline-flex items-center justify-center gap-2 rounded-xl bg-red-600 px-5 py-3 text-sm font-bold text-slate-900 shadow-sm transition hover:bg-red-700 active:scale-[0.98]"
            >
            ...
            <button
              ...
              className="inline-flex text-white items-center justify-center gap-2 rounded-xl bg-slate-900 px-5 py-3 text-sm font-bold  transition active:scale-[0.98]"
            >
