...
export default function ScanPage() {
  ...
  return (
    <main className="relative min-h-full overflow-hidden bg-slate-50 px-4 py-10 sm:px-6 lg:px-8">
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <div className="absolute -left-32 -top-32 h-96 w-96 rounded-full bg-emerald-100/50 blur-[100px]" />
        <div className="absolute -right-32 top-1/4 h-[28rem] w-[28rem] rounded-full bg-sky-100/50 blur-[110px]" />
        <div className="absolute bottom-[-12rem] left-1/3 h-96 w-96 rounded-full bg-amber-100/40 blur-[100px]" />
        <div className="absolute inset-0 bg-[linear-gradient(rgba(148,163,184,0.08)_1px,transparent_1px),linear-gradient(90deg,rgba(148,163,184,0.08)_1px,transparent_1px)] bg-[size:50px_50px]" />
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,transparent_0%,#f8fafc_78%)]" />
      </div>
          ...
          {!scanId ? (
            ...
            >
              ...
              <motion.div
                ...
                className="relative"
              >
                <div className="absolute -inset-px rounded-[2rem] bg-gradient-to-r from-emerald-300/40 via-sky-300/20 to-amber-300/20 opacity-70 blur-sm" />

                <div className="relative rounded-[2rem] border border-slate-200 bg-white p-2 shadow-[0_20px_60px_rgba(15,23,42,0.10)] backdrop-blur-xl sm:p-3">
              ...
              >
                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4 text-center backdrop-blur-sm">
